...
applicable to just a set of numbers (sample). Additionally, there's a theoretical variance of probability distribution. Of course their are tightly related.
:::
...
$$
\sum_{Y}{y_i^2} = \sum{a_i}^2 + \sum{b_i}^2
$$
...
total variance decomposes into the weighted average of variances of groups, 
...
which can't be reduced (this is why it's also called **irreducible variance**).
